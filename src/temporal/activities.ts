...
/**
 * Temporal activities for Logan remediation agent execution.
 *
...
export async function runFixPlanAgent(input: ActivityInput): Promise<AgentMetrics> {
  return runAgentActivity('fix-plan', input);
}

export async function runFixInjectionAgent(input: ActivityInput): Promise<AgentMetrics> {
  return runAgentActivity('fix-injection', input);
}

export async function runFixXssAgent(input: ActivityInput): Promise<AgentMetrics> {
  return runAgentActivity('fix-xss', input);
}

export async function runFixAuthAgent(input: ActivityInput): Promise<AgentMetrics> {
  return runAgentActivity('fix-auth', input);
}

export async function runFixSsrfAgent(input: ActivityInput): Promise<AgentMetrics> {
  return runAgentActivity('fix-ssrf', input);
}

export async function runFixAuthzAgent(input: ActivityInput): Promise<AgentMetrics> {
  return runAgentActivity('fix-authz', input);
}

export async function runFixReviewAgent(input: ActivityInput): Promise<AgentMetrics> {
...
export async function runCompareAgent(input: ActivityInput): Promise<AgentMetrics> {
  return runAgentActivity('compare', input);
}
