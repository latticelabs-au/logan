...
/**
 * Temporal worker for Logan remediation pipeline.
 *
 * Polls the 'logan-pipeline' task queue and executes activities.
...
async function runWorker(): Promise<void> {
  ...
  console.log('Logan worker started');
  console.log('Task queue: logan-pipeline');
